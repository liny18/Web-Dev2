  ...
  useEffect(() => {
    try {
      const fetchImage = async (query: string) => {
        const response = await fetch(`https://liny18.eastus.cloudapp.azure.com/node/ITWS4500-S23-liny18/api/v1/images?country=${query}`);
  ...
  useEffect(() => {
    try {
      const fetchAll = async () => {
        const response = await fetch("https://liny18.eastus.cloudapp.azure.com/node/ITWS4500-S23-liny18/api/v1/all");
        const data = await response.json();
  ...
  useEffect(() => {
    try {
      const fetchCountry = async (query: string) => {
        const response = await fetch(`https://liny18.eastus.cloudapp.azure.com/node/ITWS4500-S23-liny18/api/v1/countries?country=${query}`);
        const data = await response.json();
