  ...
  return (
    <div className="flex flex-col gap-2 bg-white bg-opacity-20 border-l-teal-100 border-l-4 p-5 fixed top-[40%] shadow-md">
      ...
      {context.choice === "Map" ? (
        ...
        <p className="font-bold text-8xl text-white overflow-y-scroll max-w-5xl max-h-24">"{context.output}"</p>
      )
      }
      <p className="font-semibold text-lg text-white">Click on another button to change content.</p>
    </div>
  );
};